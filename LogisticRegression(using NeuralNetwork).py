...
def propagate(w, b, X, Y):
    ...
    cost = np.sum(-Y*np.log(A)-(1-Y)*np.log(1-A))/m                       # compute cos
...
#TestCase(OUTPUT:- train accuracy: 100.0 % ;test accuracy: 70.0 %)
d = model(train_set_x, train_set_y, test_set_x, test_set_y, num_iterations = 1000, learning_rate = 0.09, print_cost = True)
...
learning_rates = [.005, .06, 0.01, 0.001, 0.0001]
models = {}
